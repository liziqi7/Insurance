...
var global_lineLink = location.href.split('#')[0];
var WeiXinShare = {
	imgUrl: global_origin + "/resource/images/icon.png", //注意必须是绝对路径
	lineLink: global_lineLink, //同样，必须是绝对路径  
	shareTitle: '分享title！', //分享title
	descContent: '分享给朋友或朋友圈时的文字简介', //分享给朋友或朋友圈时的文字简介
	img_width: "100",
	img_height: "100"
};
// 微信分享统计，在微信分享成功之后的回调函数
